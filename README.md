...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4084&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/plac-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `plac` can be installed with `conda`:
...
It is possible to list all of the versions of `plac` available on your platform with `conda`:
...
```
mamba search plac --channel conda-forge
```
...
mamba repoquery search plac --channel conda-forge

# List packages depending on `plac`:
mamba repoquery whoneeds plac --channel conda-forge

# List dependencies of `plac`:
mamba repoquery depends plac --channel conda-forge
```
